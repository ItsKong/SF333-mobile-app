...
const styles = StyleSheet.create({
  ...
  header: { marginTop: 10, fontSize: 20, fontWeight: "bold", textAlign: "center" },
  moodEmoji: { fontSize: 60, textAlign: "center", marginVertical: 10 },
  subHeader: { marginTop: 20, fontSize: 20, fontWeight: "600" },
  moodRow: { flexDirection: "row", marginTop: 5 },
  moodHistory: { fontSize: 30, marginRight: 5 },
  taskContainer: { marginTop: 20, backgroundColor: "#DBE8F5", padding: 15, borderRadius: 10 },
  taskCard: { flexDirection: "row", justifyContent: "space-between", backgroundColor: "#fff", padding: 15, borderRadius: 8, marginBottom: 20 },
  taskTitle: { fontSize: 18, color: "#000" },
  taskStatus: { fontSize: 18, color: "#000", fontWeight: "600" },
  done: { color: "green" },
  missed: { color: "red" },
